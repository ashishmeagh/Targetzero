                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?= Html::a( 'Download', [ 'jobsite-template' ], ["class" => "btn btn-link btn-raised"] );  ?>
<!--                                <input type="button" value="Download" class="btn btn-link btn-raised"/>-->
                            </td>
                        </tr>
<!--                        <tr>-->
<!--                            <th>Template (data)</th>-->
<!--                            <td><input type="button" id="jobsite-data-template" value="Download"/></td>-->
<!--                        </tr>-->
                        <tr>
                            <th>Upload file</th>
                            <td>
