<?php
    ...
    $this->title = 'Injury Types';
    $this->params['breadcrumbs'][] = $this->title;
?>
<div class="injury-type-index">
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function($data)
                        {
                            return Html::a( $data->injury_type, ['/injury-type/update?id='.$data->id]);
                        },
                        'label' => 'Injury Type',
                    ],
                    [
...
<script>
	...
	var deleteItem = function(item_id){
		...
		swal({ 
			...
			if(isConfirm){
                executeAjax("<?= Yii::$app->urlManager->createUrl('injury-type/delete?id=') ?>"+item_id).done(function(r){
					if(r){
